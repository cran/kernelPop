...
\newcommand{\SD}{\texttt{KernelPop}}
\newcommand{\code}[1]{\texttt{#1}}
\title{KernelPop}
\author{Allan E. Strand\\[14pt] Department of Biology\\College of
...
library(kernelPop)
set.seed(123) ###change this if you use this code!
@ 

\section{Introduction}
\label{sec:introduction}
\SD is a software environment for simulating population genetics in a
...
Landscapes, habitats, populations, individuals, and loci.  \SD
...
For most uses of \SD, these matrices can be set to zero in each cell.
...
The code snippets above should leave files in the 'inst/doc' directory of your \SD installation.
